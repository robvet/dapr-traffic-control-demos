...
namespace FineCollectionService.Controllers
{
    ...
    public class CollectionController : ControllerBase
    {
        ...
        // Topic attribute links the Topic to the CollectFine method
        // Method is invoked for each message in Topic -- explicit polling not required
        [Topic("pubsub", "collectfine")]
        [Route("collectfine")]
        [HttpPost()]
        // Method signature using the Dapr HTTP API
